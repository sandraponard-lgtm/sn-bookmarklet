...
{ f: "CSDM", c: "#2ec5e0", i: "🧩", l: [
  { section: "Idéation & Stratégie" },
    { t: "Idée de Produit",         u: "/sn_align_core_product_idea_list.do",     ic: "🟡", tbl: "sn_align_core_product_idea" },
    { t: "Élément de planification", u: "/sn_align_core_planning_item_list.do",   ic: "🟡", tbl: "sn_align_core_planning_item" },
    { t: "Plan stratégique",        u: "/sn_gf_plan_list.do",                     ic: "🟡", tbl: "sn_gf_plan" },
    { t: "Priorité stratégique",    u: "/sn_gf_strategy_list.do",                 ic: "🟡", tbl: "sn_gf_strategy" },
    { t: "Objectif",                u: "/sn_gf_goal_list.do",                     ic: "🟡", tbl: "sn_gf_goal" },
    { t: "Cible",                   u: "/sn_gf_goal_target_list.do",              ic: "🟡", tbl: "sn_gf_goal_target" },
  ...
  { section: "Design & Planning" },
    ...
    { t: "Objet d'information",     u: "/cmdb_ci_information_object_list.do",     ic: "🔵", tbl: "cmdb_ci_information_object" },
  { section: "Build & Intégration" },
    { t: "Composant SDLC",          u: "/cmdb_ci_sdlc_component_list.do",         ic: "🔴", tbl: "cmdb_ci_sdlc_component" },
  { section: "Fondations" },
    { t: "Flux de valeur",          u: "/cmn_value_stream_list.do",               ic: "⚪", tbl: "cmn_value_stream" },
    { t: "Étape du flux de valeur", u: "/cmn_value_stream_stage_list.do",         ic: "⚪", tbl: "cmn_value_stream_stage" },
    { t: "Processus métier",        u: "/cmdb_ci_business_process_list.do",       ic: "⚪", tbl: "cmdb_ci_business_process" },
    { t: "Modèle de produit",       u: "/cmdb_model_list.do",                     ic: "⚪", tbl: "cmdb_model" },
    { t: "Modèle composant logiciel", u: "/cmdb_sw_component_model_list.do",      ic: "⚪", tbl: "cmdb_sw_component_model" },
    { t: "Localisation",            u: "/cmn_location_list.do",                   ic: "⚪", tbl: "cmn_location" },
    { t: "Société",                 u: "/core_company_list.do",                   ic: "⚪", tbl: "core_company" },
    { t: "Unité commerciale",       u: "/business_unit_list.do",                  ic: "⚪", tbl: "business_unit" },
]},
